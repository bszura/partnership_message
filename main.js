...
const ad1 = `
# 🎰 JEDNO KLIKNIĘCIE. NIESKOŃCZONE EMOCJE
Sloty. Blackjack. Ruletka. Turnieje.
Zero złotówek. Sto procent adrenaliny.
Jesteśmy na początku drogi – ale cel mamy jeden:
**👑 NAJWIĘKSZY SERWER KASYNO W POLSCE**
Pierwsi gracze dostają największe bonusy i ekskluzywne rangi.
Za miesiąc będziesz żałować, że nie dołączyłeś dziś.
> 👉 **[Dołącz teraz]( https://discord.gg/88KX2Tt7Z7 )** 👈
Przy stole zawsze jest jedno wolne miejsce. Ale nie na długo. 🃏
`;
